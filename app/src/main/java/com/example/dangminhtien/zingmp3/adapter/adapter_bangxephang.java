...
import com.example.dangminhtien.zingmp3.fragment.fragment_bangxephang_content;
...
public class adapter_bangxephang extends RecyclerView.Adapter<adapter_bangxephang.viewholder> implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        mainActivity.replace_fragment((AppCompatActivity) context, new fragment_bangxephang_content());
    }

    ...
    private void addControls(View view) {
        ...
        ln_library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mainActivity.replace_fragment((AppCompatActivity) getContext(), fragment_music_library_and_favorite.newInstance(true));
            }
        });
        ...
        ln_favorite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MainActivity mainActivity = new MainActivity();
                mainActivity.replace_fragment((AppCompatActivity) getContext(), fragment_music_library_and_favorite.newInstance(false));
            }
        });

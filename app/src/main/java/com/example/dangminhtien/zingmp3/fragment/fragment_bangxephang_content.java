...
public class fragment_bangxephang_content extends Fragment {
    private RecyclerView rcv_bxh;
    private ArrayList<music> src_music;
    private OnFragmentInteractionListener mListener;

    public fragment_bangxephang_content() {
    }
    ...
    public static fragment_bangxephang_content newInstance() {
        fragment_bangxephang_content fragment = new fragment_bangxephang_content();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_bangxephang_content, container, false);
    }
